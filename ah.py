...
komen = random.choice(['Mantap bang @[100051967952842:0] I Love You','Pengguna script ganja kamu bang @[100051967952842:0]','Kamu ganteng banget deh @[100051967952842:0]','Kamu ganteng banget deh bang @[100051967952842:0]','Kamu manis bang bang @[100051967952842:0]','Kamu cantik banget anak siapa @[100051967952842:0]','Kamu ganteng banget bang @[100051967952842:0]','Mantap bang love you','bas nggak ada obat script nya emang','pengin kaya elu bang bisa ngocok stading @[100051967952842:0]'])
...
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Author   : Basari Hengker Tzy
 [\x1b[1;96m+%s] Github   : https://github.com/Basari-ID
 [\x1b[1;96m+%s] Facebook : fb.com/basari.shp
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
	...
	def __login__(self):
		...
		if token in ['']:
			...
			try:
				...
				print('\n [%s+%s] Login berhasil cuy --> %s'%(H,N,cc))
				self.bot()
			except KeyError:
